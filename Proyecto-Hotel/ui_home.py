...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_32.setStyleSheet(u"QPushButton#pushButton_32 {border: 2px solid #F2E8DB; \n" "border-radius: 30px; \n" "padding: 5px;\n" "background-color: #F2E8DB; color: black;}\n" "QPushButton#pushButton_32:hover {background-color: #d0767f; color: white;}")
        icon1 = QIcon()
